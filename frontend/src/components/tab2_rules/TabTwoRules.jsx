    ...
    <div className="space-y-8">
      ...
      <div className="bg-white p-4 rounded-xl border border-slate-200 shadow-xs flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
        <div className="flex items-center gap-3 w-full sm:w-auto">
          <label className="text-xs font-bold text-slate-700 whitespace-nowrap flex items-center gap-1.5">
            <Lock className="w-3.5 h-3.5 text-[#ff5a36]" /> Selected Master Act:
          </label>
          <select
            value={selectedAct}
            onChange={(e) => handleSelectAct(e.target.value)}
            className="border border-slate-300 rounded-lg px-3 py-1.5 text-xs bg-white font-bold text-slate-800 focus:ring-2 focus:ring-[#ff5a36] outline-hidden min-w-[280px]"
          >
            {masterActs.map((a) => (
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-6 space-y-6">
        ...
        >
          <div className="flex items-center gap-2">
            {builderCollapsed ? <ChevronRight className="w-4 h-4 text-slate-400" /> : <ChevronDown className="w-4 h-4 text-[#ff5a36]" />}
            <div>
        ...
        <div className="p-4 bg-[#fff1ec]/40 rounded-xl border border-[#ffe4da] space-y-2">
          <div className="flex justify-between items-center">
            <label className="text-xs font-bold text-slate-800 block">Chapter / Part Title *</label>
            <span className="text-[11px] font-bold text-[#c8431f] bg-white px-2.5 py-0.5 rounded-full border border-[#ffc7ae]">
        ...
        <div className="space-y-6">
          {builderRules.map((rule, rIdx) => (
            <div key={rIdx} className="bg-white rounded-xl border-2 border-[#ffe4da] p-5 space-y-5 shadow-2xs">
              <div className="flex justify-between items-center border-b border-slate-100 pb-2">
                <span className="bg-[#fff1ec] text-[#c8431f] font-extrabold text-[11px] px-2.5 py-1 rounded border border-[#ffc7ae]">
              ...
              {/* Sections Under Rule */}
              <div className="space-y-4 pl-3 border-l-2 border-[#ff9269]">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="text-[#ff5a36] hover:text-[#9c3417] text-xs font-bold flex items-center gap-1 bg-[#fff1ec] px-2.5 py-1 rounded border border-[#ffc7ae]"
                  >
                ...
                {rule.sections.map((sec, sIdx) => (
                  <div key={sIdx} className="bg-slate-50/70 p-4 rounded-xl border border-slate-200 space-y-4">
                    <div className="flex justify-between items-center pb-1">
                      <span className="text-xs font-bold text-[#7a2a13] uppercase">Section #{sIdx + 1}</span>
                            ...
                            return (
                              <button
                                ...
                                className={`text-[10px] font-bold px-2 py-0.5 rounded transition ${
                                  isDefaultAct
                                    ? "bg-[#ff5a36] text-white cursor-not-allowed opacity-90"
                                    : isActChecked
                    ...
                    <div className="p-3 bg-white rounded-lg border border-slate-200 space-y-3">
                      <div className="flex justify-between items-center">
                        ...
                        <button
                          ...
                          className="text-[#ff5a36] hover:text-[#9c3417] text-xs font-bold flex items-center gap-0.5"
                        >
                        ...
                        <div key={subIdx} className="space-y-2 border-l-2 border-slate-300 pl-3">
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="text-[11px] font-bold text-[#ff5a36] bg-[#fff1ec] px-2 py-1 rounded border border-[#ffc7ae] whitespace-nowrap"
                            >
                              + Para
                            </button>
                            <button
                                  ...
                                  return (
                                    <button
                                      ...
                                      className={`text-[10px] font-bold px-2 py-0.5 rounded ${
                                        isChecked ? "bg-[#ff5a36] text-white" : "bg-white text-slate-600 border border-slate-200"
                                      }`}
                                    >
                                      {act.item_name}
                                    </button>
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-3 border-t border-slate-100">
          {!editingContext.isEditingSingleRule ? (
            <button
              ...
              className="text-[#ff5a36] hover:text-[#9c3417] text-xs font-bold flex items-center gap-1.5 bg-[#fff1ec] px-3.5 py-2 rounded-lg border border-[#ffc7ae]"
            >
          ...
          <button
            ...
            disabled={saving}
            className="bg-[#ff5a36] hover:bg-[#c8431f] text-white px-6 py-2.5 rounded-lg text-xs font-bold flex items-center gap-2 shadow-xs transition"
          >
      ...
      <div className="bg-white rounded-xl border border-slate-200 shadow-xs p-6 space-y-6">
        <div className="border-b border-slate-100 pb-3">
          <h2 className="text-sm font-bold text-slate-800 flex items-center gap-2">
            <BookOpen className="w-4 h-4 text-[#ff5a36]" /> Legal Structure Explorer
          </h2>
            ...
            <button
              ...
              className={`px-3.5 py-1.5 rounded-lg text-xs font-bold transition flex items-center gap-1.5 ${
                selectedAct === act.item_name
                  ? "bg-white text-[#c8431f] shadow-xs border border-slate-200"
            ...
            return (
              <div key={chap.id} className="border border-slate-200 rounded-xl overflow-hidden shadow-2xs">
                ...
                <div
                  ...
                  className="bg-[#0b3f3c] text-white p-4 flex flex-col sm:flex-row justify-between sm:items-center gap-3 cursor-pointer hover:bg-[#12504c] transition select-none"
                >
                  <div className="flex items-center gap-2">
                    {isChapExpanded ? <ChevronDown className="w-4 h-4 text-[#ff9269]" /> : <ChevronRight className="w-4 h-4 text-slate-400" />}
                  ...
                  <div className="flex items-center gap-2 text-[11px] font-bold" onClick={(e) => e.stopPropagation()}>
                    <span className="bg-[#12504c] px-2.5 py-0.5 rounded text-[#d3ece8]">{rulesCount} Rules</span>
                    <span className="bg-[#5a1c0c] text-[#ffb495] px-2.5 py-0.5 rounded">{sectionsCount} Sections</span>
                    ...
                    <button
                      ...
                      className="ml-2 bg-[#17423b] hover:bg-[#1d5148] text-white px-2.5 py-1 rounded text-xs font-bold flex items-center gap-1 shadow-xs transition"
                    >
                    ...
                    <button
                      ...
                      className="bg-[#ff5a36] hover:bg-[#c8431f] text-white px-2.5 py-1 rounded text-xs font-bold flex items-center gap-1 shadow-xs transition"
                    >
                        ...
                        >
                          ...
                          >
                            <div className="flex flex-wrap items-center gap-2">
                              {isRuleExpanded ? <ChevronDown className="w-4 h-4 text-[#ff5a36]" /> : <ChevronRight className="w-4 h-4 text-slate-400" />}
                              <span className="bg-[#fff1ec] text-[#c8431f] font-extrabold text-xs px-2.5 py-0.5 rounded border border-[#ffc7ae]">
                                RULE NO. {rule.rule_order || (rIdx + 1)}
                              </span>
                            ...
                            <div className="flex items-center gap-2" onClick={(e) => e.stopPropagation()}>
                              ...
                              <button
                                ...
                                className="bg-[#fff1ec] hover:bg-[#ffe4da] text-[#c8431f] border border-[#ffc7ae] px-3 py-1 rounded text-xs font-bold flex items-center gap-1 transition"
                              >
                                ...
                                {rule.sections?.map((sec, sIdx) => (
                                  <div key={sec.id || sIdx} className="bg-slate-50 rounded-xl p-4 border border-slate-200 space-y-3">
                                    <div className="flex flex-wrap justify-between items-center gap-2">
                                      <h4 className="font-bold text-xs text-[#9c3417]">
                                      ...
                                      <div className="flex items-center gap-1">
                                        ...
                                        {withDefaultAct(sec.mapped_acts, chap.act_code).map((ma, mIdx) => (
                                          <span key={mIdx} className="bg-[#ffe4da] text-[#9c3417] text-[10px] font-bold px-1.5 py-0.5 rounded">
                                            {ma}
                                          </span>
                                        ))}
                                      </div>
                                            ...
                                            {ass.processes.map((proc, pIdx) => (
                                              <div key={pIdx} className="grid grid-cols-1 md:grid-cols-4 gap-2 bg-slate-50 p-2.5 rounded-lg border border-slate-200 text-xs items-center">
                                                <div className="md:col-span-2">
                                                  <span className="font-bold text-[#c8431f] block text-[11px]">Process No. {pIdx + 1}</span>
              ...
              {[50, 100, 150].map((size) => (
                <button
                  ...
                  className={`px-2.5 py-1 rounded-md text-[11px] font-bold border transition ${
                    chapterPageSize === size ? "bg-[#ff5a36] text-white border-[#ff5a36]" : "bg-slate-50 text-slate-600 border-slate-200 hover:bg-slate-100"
                  }`}
                >
                  {size}
                </button>
            ...
            <form onSubmit={handleConfirmEditChapter} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full border border-slate-300 rounded-lg p-2.5 text-xs text-slate-800 focus:ring-2 focus:ring-[#ff5a36] outline-hidden"
                />
              </div>
              ...
              <div className="flex justify-end gap-2 pt-2 border-t border-slate-100">
                ...
                <button
                  ...
                  className="bg-[#ff5a36] hover:bg-[#c8431f] text-white px-4 py-2 rounded-lg font-bold flex items-center gap-1.5 disabled:opacity-60"
                >
      ...
      {addRuleModal.open && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-xs p-4">
          <div className="bg-white rounded-2xl max-w-xl w-full border border-slate-200 shadow-2xl p-6 space-y-4 text-xs animate-in fade-in zoom-in duration-150">
            ...
            <div className="flex justify-between items-center border-b border-slate-100 pb-3">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-lg bg-[#fff1ec] text-[#ff5a36] flex items-center justify-center font-bold">
                  <PlusCircle className="w-4 h-4" />
                </div>
                <div>
                  <h3 className="text-sm font-bold text-slate-800">Add New Rule to Chapter</h3>
                  <span className="text-[11px] text-[#ff5a36] font-medium block">
            ...
            <form onSubmit={handleConfirmAddRuleToChapter} className="space-y-4">
              <div>
                ...
                <textarea
                  ...
                  className="w-full border border-slate-300 rounded-lg p-2.5 text-xs text-slate-800 focus:ring-2 focus:ring-[#ff5a36] outline-hidden resize-y"
                />
              </div>
              ...
              <div className="flex justify-end items-center gap-2 pt-3 border-t border-slate-100">
                ...
                <button
                  type="submit"
                  disabled={saving}
                  className="bg-[#ff5a36] hover:bg-[#c8431f] text-white px-5 py-2 rounded-lg font-bold flex items-center gap-1.5 shadow-xs transition"
                >
