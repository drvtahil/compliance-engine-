        ...
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-base font-bold text-slate-800 flex items-center gap-2">
              <Activity className="w-5 h-5 text-[#ff5a36]" /> Activity Tracker
            </h2>
                  ...
                  return (
                    <tr key={act.id} className="hover:bg-slate-50/80">
                      ...
                      <td className="p-3 text-right">
                        <button onClick={() => setViewing(act)} title="View Details" className="text-slate-400 hover:text-[#ff5a36] p-1 rounded hover:bg-slate-100">
