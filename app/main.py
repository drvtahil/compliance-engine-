...
app.include_router(tab4_assignments.router)
...
app.include_router(account_resources.router)
app.include_router(account_readiness.router)
...
app.include_router(account_assignments.router)
app.include_router(account_portal.router)
