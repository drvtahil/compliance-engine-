...
from app.routers.account_portal import auth as account_auth, rules as account_rules, users as account_users, questions as account_questions, resources as account_resources, readiness as account_readiness
